...
This pipeline performs k-mer based genome-wide association studies (GWAS) using the kmersGWAS method (Voichek & Weigel, 2020). It takes raw sequencing reads through to significant k-mer associations with your phenotype. See also https://github.com/voichek/kmersGWAS
